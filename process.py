...
def clean_transform(data_file: str, output_dir) -> DataFrame:
    """
...
def stock_analyze(input_file, output_dir):
    try:
        df_transformed = clean_transform(input_file, DATA_OUT_PUT_PATH)
...
if __name__ == "__main__":
    ...
    PROJECT_DIR = "/Users/tramln/working/apple_interview/app/apple_stock"
    input_file = os.path.join(PROJECT_DIR, DATA_SOURCE_PATH,
                              "finance-charts-apple.csv")
    output_dir = os.path.join(PROJECT_DIR, DATA_OUT_PUT_PATH)
